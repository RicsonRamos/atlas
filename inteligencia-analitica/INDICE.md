# Índice Mestre — Inteligência Analítica e Forense de Dados

3 disciplinas em 1 domínio pedagógico principal.
...
## DAG de dependências
```
D01.01 (Redes/Grafos) ──> D01.02 (OSINT) ──> D01.03 (NLP Forense)
```

## Carga horária total
- Trilha completa: ~72-90h
